...
var lock = {
    ...
    lockTypes: {
        ...
        "default": {
             ...
             * @type String
             */
            //todo new default locker from @Natasha
...
Form.prototype.send = function (sendOptions) {
    var that = this;
    if (sendOptions.lockType !== 'none') {
        sendOptions.onProgress = spiral.lock.addLock(sendOptions.lockType, sendOptions.context);
    }
    ...
    this.spiral.ajax.send(sendOptions).then(
        ...
        function(error){
            ...
            if (sendOptions.lockType !== 'none') {
                that.spiral.lock.removeLock(sendOptions.lockType, sendOptions.context);
            }
