...
const FileInput = function (sf, node, options) {
 ...
 */
FileInput.prototype = Object.create(core.core.BaseDOMConstructor.prototype);
...
FileInput.prototype.addFileEventListeners = function () {
  ...
  this._inputChange = function (e) {
    const label = that.els.node.nextElementSibling;
